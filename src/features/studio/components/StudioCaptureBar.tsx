...
export function StudioCaptureBar({
  ...
  return (
    <div className="absolute inset-x-0 bottom-0 z-20 flex flex-col items-center pb-safe-bottom pb-8 sm:pb-10">
      <div className="flex items-center gap-8">
        ...
        >
          ...
          />
          {isDone && (
            <svg className="absolute h-6 w-6 text-white" viewBox="0 0 20 20" fill="currentColor" aria-hidden>
